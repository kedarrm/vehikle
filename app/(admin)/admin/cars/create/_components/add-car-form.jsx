                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div
                                            {...getMultiImageRootProps()} className={`border-2 border-dashed rounded-lg p-6 text-center 
                                    ...
                                    <Button type="submit" className="w-full mt-4 cursor-pointer md:w-auto" disabled={addCarLoading}>
